        ...
        h(
          ...
          h(
            ...
            session.isAdmin
              ...
              : session.pinOnly
                ? 'Datos locales (sin sincronización)'
                : session.guest
    ...
    h(
      ...
      Object.keys(RC).map(function (k) {
        ...
        return h(
          ...
          h(
            'span',
            { className: 'cfg-k', style: { fontSize: 13.5 } },
            h(
              'span',
              {
                className: 'rec-chip',
          ...
          h(
            'span',
            { className: 'cfg-v', style: { color: r.color } },
    ...
    showMgtAcct
      ? h(
          'div',
          {
            className: 'ovl',
            onClick: function (ev) {
              if (ev.target === ev.currentTarget) setShowMgtAcct(false);
            }
          },
    ...
    showDiag
      ? h(
          'div',
          {
            className: 'ovl',
            onClick: function (ev) {
              if (ev.target === ev.currentTarget) setShowDiag(false);
            }
          },
          h(DiagnosticoModal, {
            session: session,
    ...
    showAsignar
      ? h(
          'div',
          {
            className: 'ovl',
            onClick: function (ev) {
              if (ev.target === ev.currentTarget) setShowAsignar(false);
            }
          },
          h(AsignarPINsModal, {
            session: session,
    ...
    showUsuarios
      ? h(
          'div',
          {
            className: 'ovl',
            onClick: function (ev) {
              if (ev.target === ev.currentTarget) setShowUsuarios(false);
            }
          },
          h(UsuariosModal, {
            session: session,
