...
const CACHE = 'mt-v27'; // Fix sync salario: UPSERT + local como fuente de verdad
const CDN = [
...
// ── install: cache + skipWaiting + notificar clientes ──
// En subcarpeta (GitHub Pages) el skipWaiting() puede no activar el SW
// si no hay navegación inmediata. Forzamos notificando a todos los clientes.
...
// ── activate: limpiar caches viejos + claim + notificar ──
...
// ── message: soporte para skipWaiting + GET_CACHE_NAME ──
